...
const NavBar = () => {
  ...
  return (
    <div className =' flex item-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400' >
        <img className='w-44 cursor-pointer' src={assets.logo} alt="Logo" style={{ width: '100px', height: '100px', marginRight: '20px' }} />
        ...
        <img onClick={()=> setShowMenu(true)} className='w-6 m:hidden' src={assets.menu_icon} alt = "" />
         {/* ---- Mobile Menu ---- */}
